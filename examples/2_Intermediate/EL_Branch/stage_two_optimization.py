...
<<<<<<< HEAD:examples/2_Intermediate/stage_two_optimization.py
                         GaussianSampler, CurvePerturbed_json_fix,
...
>>>>>>> EL_1:examples/2_Intermediate/EL_Branch/stage_two_optimization.py
